    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="text-lg font-extrabold leading-none tracking-tight">
          BHU SATYA <span className="accent-text">2.0</span>
        </div>
        ...
        >
          ...
          <div className="mt-6 border-t border-[var(--border-subtle)] pt-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button onClick={() => fillDemo("admin@bhusatya.gov.in", "admin123")} className="rounded-lg border border-[var(--border-subtle)] bg-white/[0.03] px-3 py-2 text-left transition-colors hover:border-[var(--accent)]/50 hover:bg-[var(--accent-soft)]">
                <div className="text-xs font-semibold">District Admin</div>
                <div className="tabular mt-0.5 text-[10px] text-muted">admin@bhusatya.gov.in</div>
              </button>
              <button onClick={() => fillDemo("officer@bhusatya.gov.in", "officer123")} className="rounded-lg border border-[var(--border-subtle)] bg-white/[0.03] px-3 py-2 text-left transition-colors hover:border-[var(--accent)]/50 hover:bg-[var(--accent-soft)]">
                <div className="text-xs font-semibold">Review Officer</div>
                <div className="tabular mt-0.5 text-[10px] text-muted">officer@bhusatya.gov.in</div>
              </button>
            </div>
          </div>
        </motion.div>

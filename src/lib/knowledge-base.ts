...
export const KNOWLEDGE_BASE: KnowledgeArticle[] = [
  ...
  },
  {
    ...
    content: "OCR means Optical Character Recognition. It detects printed or handwritten characters in a scan and converts them into machine-readable text. Bhu Satya combines OCR with AI/NLP to map the text into land-record fields and score extraction confidence.",
...
export function answerFromKnowledge(question: string) {
  ...
  if (!best || best.score === 0) return {
    answer: "Bhu Satya AI is the workspace assistant for digitizing land records. Upload a scanned handwritten register or image; OCR reads it, AI/NLP extracts fields and confidence scores, validation checks the result, and officers review only exceptions. For a specific answer, ask about upload, OCR, scoring, validation, GIS, exports, security, audit, or backup.",
